    ...
    <div className='space-y-4'>
      <Card>
        <CardHeader>
          ...
          <CardDescription>Cliques e visitantes únicos semanalmente</CardDescription>
        </CardHeader>
      ...
      <div className='grid gap-4 sm:grid-cols-2 lg:grid-cols-4'>
        ...
        <Card>
          <CardHeader className='flex flex-row items-center justify-between space-y-0 pb-2'>
            <CardTitle className='text-sm font-medium'>Média de Sessão</CardTitle>
            <svg
              xmlns='http://www.w3.org/2000/svg'
              viewBox='0 0 24 24'
              fill='none'
      ...
      <div className='grid grid-cols-1 gap-4 lg:grid-cols-7'>
        <Card className='col-span-1 lg:col-span-4'>
          ...
          <CardContent>
            <SimpleBarList
              items={[
                { name: 'Whatsapp', value: 512 },
                { name: 'Instagram', value: 238 },
        ...
        <Card className='col-span-1 lg:col-span-3'>
          ...
          <CardContent>
            <SimpleBarList
              items={[
                { name: 'Computador', value: 74 },
                { name: 'Celular', value: 22 },
                { name: 'Tablet', value: 4 },
              ]}
